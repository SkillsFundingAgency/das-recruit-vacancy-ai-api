...
public class AiReviewResultV1: IAiReviewResult
{
    ...
    public AzureAiResponse<Dictionary<string, string>> ContentEvalResult_Manual { get; set; }
    public AzureAiResponse<Dictionary<string, string>> ContentEvalResult_Copilot { get; set; }
